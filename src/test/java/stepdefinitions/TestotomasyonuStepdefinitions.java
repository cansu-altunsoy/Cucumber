...
public class TestotomasyonuStepdefinitions {
    ...
    public void aramaSonuUrunBulunamadiginiTestEder() {

        String exceptionUrunAramaSnuc = ConfigReader.getProperty("toUnexpectedSonuc");
        String actualUrunAramaSonuc = testotomasyonuPage.aramaSonucuElementi.getText();

        Assertions.assertEquals(exceptionUrunAramaSnuc, actualUrunAramaSonuc);
    ...
    public void aramaKutusunaTestDataDosyasindakiBelirlenenKelimeYazipAratir() {
    ...
    public void password_olarak_girer(String configIstenPassword) {

        testotomasyonuPage.passwordKutusu.sendKeys(ConfigReader.getProperty(configIstenPassword));
    ...
    @Then("arama sonucun {string} veya daha fazla urun bulunabildigini test eder")
    public void aramaSonucunVeyaDahaFazlaUrunBulunabildiginiTestEder(String belirlenenMiktarStr) {
        ...
        2-  bulunan urunleri findElements ile locate edip bir listeye koyabilir
           ve Listenin size()'ni bakabiliriz
    ...
    @When("email olarak verilen {string} girer")
    public void emailOlarakVerilenGirer(String direktEmail) {
    ...
    //  Excel islemlerini sadece 1 kere US1015'e ozel bir calisma olacagi
    //  icin testotomasyonu sayfası icinde yapıyoruz
    ...
    @Then("bulunan sonuc sayisini excelde {string} daki {int}.sutuna yazar")
    public void bulunan_sonuc_sayisini_excelde_daki_sutuna_yazar(String satirNoStr, Integer sutunNo) throws IOException {

        // once workbook'da istenen işlemi yapalim
        int satirNo = Integer.parseInt(satirNoStr);
        calisilanSayfa.getRow(satirNo - 1).createCell(sutunNo - 1)
