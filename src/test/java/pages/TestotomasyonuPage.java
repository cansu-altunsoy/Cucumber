...
public class TestotomasyonuPage {
    ...
    Page class'larinda locate yapabilmesi icin WebDriver objemizi bu class'a tanitmamiz gerekiyor

    Bu tanitma islemini yapmak icin constructor ici tercih edilmis, bu islemin sebebi;
    Test class'larindan page class'ina ulasmak icin obje olusturma yontemini kullanmamizdir
