...
@ConfigurationParameter(key = Constants.EXECUTION_DRY_RUN_PROPERTY_NAME,value = "false")
  ...
  //@ConfigurationParameter(key = Constants.PLUGIN_PROPERTY_NAME,value = "pretty, html:target/cucumber-report/HtmlReport.html") // Test sonucunu raporlar
...
public class Runner {
    ...
    /*
     Cucumber'daki Runner Class'i icine hic kod yazilmaz

     gorevi TestNG'deki .xml gibi toplu calismayi saglamaktir
     Runner Class'i gorevini kullanacagımız Notasyonlar ile
     */
